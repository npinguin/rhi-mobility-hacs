...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback) -> None:
    ...
    def sync() -> None:
        ...
        for asset_id,asset in sorted(manager.assets.items()):
            # Contract applicability owns entity existence. Missing source/control
            # evidence only changes Entity.available; it must never delete the product
            # property from Home Assistant.

...
class MobilityEnergyV2Provider:
    ...
    def _consumer(self, aid: str, snap) -> dict[str, Any]:
        ...
        limits = {
            ...
            "current_limit_a": requested_current if requested_current is not None else cvals.get("charger.current_limit_a"),
            "offered_current_a": cvals.get("charger.offered_current_a"),
            "current_limit_a_source": "physical_current_limit_readback" if requested_current is not None else ("source_current_limit" if cvals.get("charger.current_limit_a") is not None else None),
    ...
    def _connection(self, aid: str, snap) -> dict[str, Any]:
        ...
        return {
            ...
            "limits": {
                ...
                "requested_current_limit_a": requested_current,
                "current_limit_a": requested_current if requested_current is not None else vals.get("charger.current_limit_a"),
                "offered_current_a": vals.get("charger.offered_current_a"),
                "requested_power_kw_editable": desc is not None,
                **write_contract,
